...
**Collusion will not be tolerated. A trade will be vetoed if there is evident collusion and the guilty teams will be removed from the league and forfeit any dues paid**
  The commissioner has the ability to take draft picks or remove owners how he feels appropriate.
...
- All teams will need to pay for the first 2 years up front to help with turnover.
- Payment will through LeagueSafe: https://www.leaguesafe.com/join/3978781
- Must be paid at minimum 2 weeks before the draft (startup or rookie).

### Yearly Dues ###

- After the second year there is a yearly total of $50 that must be paid 2 weeks before the start of the yearly rookie draft.
...
- Scoring Champion: $50
- There will also be a $25 yearly rollover into the Kings Pot. The Kings Pot will be rewarded to the first team that wins 2 Championships. 
  This process will repeat for as long as the league is active. 
...
## __Section IV - Rosters__ ##
   ...
   - Taxi Squad will be for players with 1 year or less experience in the NFL. 
   - You can move players into the taxi squad until the regular season starts. Once the deadline passes, you may no longer move players to the taxi squad but you can move them        off to the IR or regular roster.
...
- There will be a league vote on the draft format (Snake or Auction).
- Trading draft picks is allowed during the startup draft.
- If a team misses their pick the best available player based on Sleepers rankings will be taken for them.
...
### Rookie Draft Order ###
- The draft order for the rookie draft will be determined based on regular season results
- Picks 1-4 will be assigned via a NBA style lottery with the bottem 4 teams participating.
- There will be a total of 30 lottery balls with teams receiving the following:
   -12th Place = 12
   -11th Place = 8
   -10th Place = 5
   -9th  Place = 5
- All other teams (1-8) will pick in inverse order of regular season finish.
- Tie breaker for draft picks will be record then possible points for.
- An additional pick (1.13) will be awarded to the winner of the consolation bracket if this is not supported by sleeper the consolation bracket winner will receive 3 lottery     balls for the rookie draft

### Rookie Draft Settings ###
- There will be 4 rounds of the rookie draft.
- The rookie draft will take place with in three weeks following the start of the NFL draft.
...
- If a team misses their pick the best available player based on Sleepers will be taken for them
...
- There will be three divisions that teams will be randomly assigned to upon joining the league.
- Division winners will have the option to rename their division the following season.
...
- The three teams that win their divisions will be assigned to the top three seeds.
